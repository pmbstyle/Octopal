...
- When launching child workers, treat `max_thinking_steps` as a hard reasoning/action budget; raise it when the child task is multi-step, tool-heavy, verification-heavy, or includes synthesis/supervision work.
