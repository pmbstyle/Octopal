...
_SAME_ENV_ENV_ALLOWLIST = {
    ...
    "OCTOPAL_BROWSER_BACKEND",
    "OCTOPAL_PINCHTAB_BASE_URL",
    "OCTOPAL_PINCHTAB_BROWSER",
    "OCTOPAL_PINCHTAB_OWNERSHIP_FILE",
    "OCTOPAL_PINCHTAB_SESSION",
    "OCTOPAL_PINCHTAB_TIMEOUT_SECONDS",
    "OCTOPAL_WEBCLAW_BINARY",
    "OCTOPAL_WEBCLAW_ENABLED",
    "OCTOPAL_WEBCLAW_PREFER_LOCAL",
    "OCTOPAL_WEBCLAW_TIMEOUT_SECONDS",
    "PATH",
    "PATHEXT",
    "PYTHONPATH",
    "Path",
