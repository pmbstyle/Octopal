...
def test_detect_textual_tool_invocation():
    ...
    assert not looks_like_textual_tool_invocation("A2A_OK")
    assert not looks_like_textual_tool_invocation("noted.")
    assert not looks_like_textual_tool_invocation("Done.")
    assert not looks_like_textual_tool_invocation("thanks")
